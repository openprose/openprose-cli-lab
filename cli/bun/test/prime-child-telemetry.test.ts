...
import fixture from "../../shared/fixtures/adapters/tool-lifecycle/prime-child-telemetry.json";
test("Prime child observations preserve active parent state and cannot complete it",()=>{
...
test("Prime child observations reject malformed shapes and wrong phase/harness",()=>{
...
test("child status does not settle pending tools or substitute for parent terminal",()=>{
